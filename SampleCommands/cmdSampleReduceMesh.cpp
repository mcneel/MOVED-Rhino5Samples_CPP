...
class CSampleReduceMeshProgressContext : public CRhinoReduceMeshProgressContext
{
public:
  CSampleReduceMeshProgressContext::eReaction ReportProgress(int, int) const
  {
    // Do nothing...
    return CRhinoReduceMeshProgressContext::rcontinue;
  }
};
