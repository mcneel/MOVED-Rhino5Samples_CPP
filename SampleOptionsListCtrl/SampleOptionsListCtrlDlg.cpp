...
IMPLEMENT_DYNCREATE(CSampleOptionsListCtrlDlg, CRhinoTabbedDockBarDialog)
...
BEGIN_MESSAGE_MAP(CSampleOptionsListCtrlDlg, CRhinoTabbedDockBarDialog)
END_MESSAGE_MAP()

const wchar_t* CSampleOptionsListCtrlDlg::Caption() const 
{ 
	return L"Sample";
}

ON_UUID CSampleOptionsListCtrlDlg::TabId() const
{
	return ID();
}

ON_UUID CSampleOptionsListCtrlDlg::ID()
{
...
ON_UUID CSampleOptionsListCtrlDlg::PlugInId() const
{
	return SampleOptionsListCtrlPlugIn().PlugInID();
}

HICON CSampleOptionsListCtrlDlg::Icon() const
{
	AFX_MANAGE_STATE( AfxGetStaticModuleState() );
	return ::LoadIcon( AfxGetInstanceHandle(), MAKEINTRESOURCE(IDI_ICON) );
}

void CSampleOptionsListCtrlDlg::OnShowTab( bool bShowTab, const ON_UUID& tabId )
{
  // TODO: Add "On Show" or "On Hide" tab code here
}

void CSampleOptionsListCtrlDlg::OnShowDockBar( bool bShowDockBar )
{
...
void CSampleOptionsListCtrlDlg::CreateGroup( 
